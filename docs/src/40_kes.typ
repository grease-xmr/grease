...
$EE_1$ is defined over a prime finite field $"GF"_1(p_1)$, with $p_1$ a large prime. Let $N_1$ be the size of the group
generated by the Generator point, $G_1$ for group $GG_1$, such that $N_1.G equiv cal(O)$.
...
#algo(
  ...
  + *if* valid:
    ...
    + *if* current time $>=$ pending.expiry
      ...
      + update `pending`, set `status` to `ForceClosed`, add `(Pc, 𝝌c, n)` to `chi`
